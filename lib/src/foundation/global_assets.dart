...
class GlobalAssets {
  ...
  static const String remote = 'packages/global_repository/assets/icon/remote.svg';
  static const String connect = 'packages/global_repository/assets/icon/connect.svg';
}
